...
//setNewScene(9,"game",[ROM_DATA.game_score,ROM_DATA.skins[0],ROM_DATA.chara[menu_char_select[0]][0],ROM_DATA.chara[menu_char_select[1]][1]])
...
function debugMenu() {
  ...
  CTX.fillText("Lilyfuse   [PREVIEW1]",0,40);
  ...
  switch (inputArray[i]) {
    ...
    case controller[0]._a:{
      switch(debug_pointer) {
        case 2:setNewScene(9,"game",[ROM_DATA.game_score,ROM_DATA.skins[0],ROM_DATA.chara[menu_char_select[0]][0],ROM_DATA.chara[menu_char_select[1]][1]]);break
      };
    }; break;
  };
  const characters = [
...
class GameField {
  constructor(player_position) {
    ...
    this.queue_rng = this.splitmix32(session_seed);
    this.game_cursor = {
      "pos":2,
      "lag":0,
      "wait":0,
    ...
    this.essence_rng = this.splitmix32(session_seed);
    this.essence = {
      "rows":0,
      "giving":0,
      "getting":0
    ...
    this.cpu_rng = this.splitmix32(session_seed);
  };
  populate() {
    let field = [];
    for (let y = 0; y < 12; y++) {
